...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_TestLiteImportsNonlite_google_2fprotobuf_2funittest_5flite_5fimports_5fnonlite_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsscc_info_TestLiteImportsNonlite_google_2fprotobuf_2funittest_5flite_5fimports_5fnonlite_2eproto}, {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ctx->ParseMessage(mutable_message_with_required(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
