...
const char descriptor_table_protodef_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto[] =
...
class TestLargeEnumValue::HasBitSetters {
 public:
